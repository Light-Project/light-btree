...
struct btree_root;
typedef void *(*btree_alloc_t)(struct btree_root *root);
...
typedef int (*btree_clash_t)(struct btree_root *root, void *clash, void *value);
...
extern void *btree_alloc(struct btree_root *root);
extern void btree_free(struct btree_root *root, void *node);

extern void *btree_lookup(struct btree_root *root, uintptr_t *key);
extern int btree_update(struct btree_root *root, uintptr_t *key, void *value);
extern int btree_insert(struct btree_root *root, uintptr_t *key, void *value);
